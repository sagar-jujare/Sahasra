...
// // Initialize Pusher client (renamed to avoid conflict)
// const localPusherClient = new Pusher(process.env.NEXT_PUBLIC_PUSHER_KEY, {
...
//   useEffect(() => {
//     const channel = localPusherClient.subscribe(chatRoom)
...
//       localPusherClient.unsubscribe(chatRoom)
//     }
//   }, [chatRoom])
// }
